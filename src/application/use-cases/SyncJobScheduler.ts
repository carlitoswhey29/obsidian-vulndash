...
import { VulnerabilitySyncService, type SyncOutcome, type SyncState } from './SyncVulnerabilitiesUseCase';
...
export type { SyncOutcome, SyncResult } from './SyncVulnerabilitiesUseCase';
